...
export KOMGA_TASKS_DB_TYPE=postgresql
export KOMGA_TASKS_DB_URL="jdbc:postgresql://localhost:5433/komga?user=komga&password=$DB_PASSWORD"
export KOMGA_TASKS_DB_USERNAME=komga
export KOMGA_TASKS_DB_PASSWORD=$DB_PASSWORD
export KOMGA_TASKS_DB_MAX_POOL_SIZE=10
